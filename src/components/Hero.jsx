...
export function Hero() {
  return (
    <Container className="pt-16 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-800 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-rose-600">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-rose-300/70"
          ...
          <span className="relative">your ideas</span>
        </span>{' '}
        to life
      </h1>
